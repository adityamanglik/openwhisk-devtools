...
ssh $OW_SERVER_NODE "docker run hello-world"
ssh $OW_SERVER_NODE "docker build --build-arg GOGC=1 --build-arg GOMEMLIMIT=128MiB -t go-server-image /users/am_CU/openwhisk-devtools/docker-compose/Native/Go/"
