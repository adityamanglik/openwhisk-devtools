...
ssh $OW_SERVER_NODE "docker run --cpuset-cpus 4 --memory=10g -d  --rm --name my-js-server -p 8801:8800 js-server-image"
sleep 5
curl "http://node0:8801/JS?seed=1000&arraysize=10000&requestnumber=56" >> Results/"res_10240.txt"
sleep 1
locust --config=master.conf
echo "" >> Results/"res_10240.txt"
python analysis.py >> Results/"res_10240.txt"
