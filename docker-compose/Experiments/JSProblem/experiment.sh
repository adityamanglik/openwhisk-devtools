...
send_requests() {
    ...
    mv $OW_DIRECTORY/JSProblem/go_response_times.txt "$OW_DIRECTORY/JSProblem/Graphs/Go/$size/client_time.txt"
    mv $OW_DIRECTORY/JSProblem/go_server_times.txt "$OW_DIRECTORY/JSProblem/Graphs/Go/$size/server_time.txt"
    mv $OW_DIRECTORY/JSProblem/go_heap_memory.log "$OW_DIRECTORY/JSProblem/Graphs/Go/$size/memory.txt"
